...
$(document).ready(function () {
  ...
  function changeBG (tagid, url) {
    $('.skin-menu ' + tagid).click(function () {
      ...
      $('#banner_wave_2').addClass('banner_wave_hide_fit_skin')
      closeSkinMenu()
      setCookie('bgImgSetting', url, cookieLifeTime)
    })
  }
  ...
  changeBGnoTrans('#bing-bg', 'http://bing.getlove.cn/bingImage') // 必应每日图片接口
  $('.skin-menu #white-bg').click(function () {
    ...
    $('#banner_wave_2').removeClass('banner_wave_hide_fit_skin')
    closeSkinMenu()
    setCookie('bgImgSetting', '', cookieLifeTime)
  })
  $('.skin-menu #dark-bg').click(function () {
    mashiro_global.variables.skinSecter = true
    mashiro_global.variables.isNight = true
    $('body').css('background-image', 'url(https://cdn.jsdelivr.net/gh/0x2710-10000/ImageBag/img/bg/background.jpg)')
  ...
  var scriptURLS = [
    "https://cdn.jsdelivr.net/gh/yremp/yremp-js@1.5/sakura.js", // 樱花飘落js
    "https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.3.3/js/snow.js", // 雪花飘落js
    "https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.3.3/js/line.js",
    "https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.4.0/js/piao.js",
    "https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.4.0/js/coderain.js",
    "https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.4.3/js/pointrain.js",
    "https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.4.5/js/raindrop.js"
  ]
  var effectCookieNames = [
    "sakuraEffectCookie",
    "snowyEffectCookie",
    "linesEffectCookie",
    "beltsEffectCookie",
  ...
  for(let j = 0; j < controlBTNIDS.length; j++) {
    $('.skin-menu ' + controlBTNIDS[j]).click(function(){
      cleanAllEffect()
      setEffect(scriptIDS[j],
                scriptURLS[j],
                effectCookieNames[j],
                cookieLifeTime);
    })
  ...
  function sakuraEffectClear(){
    return removeEffect("sakura-effect", "canvas_sakura", "sakuraEffectCookie", cookieLifeTime)
  }
  function snowEffectClear(){
      ...
      if(effect){
        ...
        setCookie('snowyEffectCookie','', cookieLifeTime)
      }
      return effect
  }
  function lineEffectClear(){
    return removeEffect("line-effect", "lines", "linesEffectCookie", cookieLifeTime)
  }
  function beltEffectClear(){
    return removeEffect("belt-effect", "belts1", "beltsEffectCookie", cookieLifeTime)
  }
  function wordEffectClear(){
    return removeEffect("words-effect", "coderain", "wordsEffectCookie", cookieLifeTime)
  }
  function pointEffectClear(){
    return removeEffect("point-effect", "point", "pointEffectCookie", cookieLifeTime)
  }
  function rainEffectClear(){
    return removeEffect("raindrop-effect", "rain", "rainEffectCookie", cookieLifeTime)
  }

  function initEffect() {
    for(var k = 0; k < effectCookieNames.length; k++) {
      if(getCookie(effectCookieNames[k]) === "use") {
        setEffect(scriptIDS[k], scriptURLS[k], effectCookieNames[k], cookieLifeTime)
        return
      }
    }
  }
  ...
  function setEffect(scriptID, scriptURL, effectCookieName, cookieDays) {
    console.log(arguments)
    var effect
    
    effect = document.createElement("script")
    effect.setAttribute("src",scriptURL)
    effect.setAttribute("id", scriptID)
    document.getElementsByTagName("body").item(0).appendChild(effect)
    setCookie(effectCookieName,'use',cookieDays)
    
    closeSkinMenu()
  }

  function removeEffect(scriptID, contentBoxID, effectCookieName, cookieDays) {
    var effect = document.getElementById(scriptID)
      if(effect){
          effect.parentNode.removeChild(effect)
          document.body.removeChild(document.getElementById(contentBoxID))
          setCookie(effectCookieName,'', cookieDays)
      }
      return effect
  }
